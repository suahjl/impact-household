...
list_ethnicities = ["bumiputera", "non_bumiputera"]  # aggregation=2
...
for quantile, suffix in tqdm(zip(list_quantiles, list_suffixes)):
    for ethnicity in list_ethnicities:
        ...
        params_table_fe, params_table_timefe, params_table_re = load_clean_estimate(
            input_suffix=suffix + "_" + ethnicity,
        ...
        params_table_fe["ethnicity"] = ethnicity
        params_table_timefe["ethnicity"] = ethnicity
        params_table_re["ethnicity"] = ethnicity
        # Indicate method
...
d = d.pivot(index="quantile", columns="ethnicity", values="Parameter")
file_name = (
...
# Compile and send
pdf_file_name = (
    "output/params_table_overall_quantile_ethnicity_consol"
    + "_"
    + outcome_choice
    + "_"
    + income_choice
...
params_table_consol.to_parquet(
    "output/params_table_overall_quantile_ethnicity"
    + "_"
    + outcome_choice
    + "_"
    + income_choice
...
#            msg='impact-household --- analysis_reg_overall_quantile_ethnicity: COMPLETED')
