...
allcombos_level_gap.to_parquet(path_output + 'impact_sim_elec_level_gap_' +
                               income_choice + '_' + outcome_choice + '_' +
                               fd_suffix + hhbasis_suffix + '_' + macro_suffix + '.parquet')
allcombos_level_gap.to_csv(path_output + 'impact_sim_elec_level_gap_' +
                           income_choice + '_' + outcome_choice + '_' +
