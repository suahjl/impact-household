...
child_benefit = 100
working_age_benefit = 100  # PHASE 3
elderly_benefit = 100
...
pil_img2pdf(list_images=list_file_names,
            extension='png',
            pdf_name=path_output + 'cost_matrix_staggered2_' +
                     'kids_elderly_flat_universal_' +
                     'wa_tiered_restrict' +
                     '_consol')
...
telsendfiles(
    conf=tel_config,
    path=path_output + 'cost_matrix_staggered2_' +
         'kids_elderly_flat_universal_' +
         'wa_tiered_restrict' +
         '_consol' + '.pdf',
    cap='cost_matrix_staggered2_' +
        'kids_elderly_flat_universal_' +
        'wa_tiered_restrict' +
        '_consol'
)
...
telsendmsg(conf=tel_config,
           msg='impact-household --- analysis_descriptive_cost_matrix_staggered2: COMPLETED')
