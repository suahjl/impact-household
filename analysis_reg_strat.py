...
heatmap_params_table_fe_consol = heatmap(
    ...
    mask=False,
    colourmap="vlag",
    outputfile="output/params_table_fe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
telsendimg(
    conf=tel_config,
    path="output/params_table_fe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
    + hhbasis_suffix
    + ".png",
    cap="params_table_fe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
heatmap_params_table_timefe_consol = heatmap(
    ...
    mask=False,
    colourmap="vlag",
    outputfile="output/params_table_timefe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
telsendimg(
    conf=tel_config,
    path="output/params_table_timefe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
    + hhbasis_suffix
    + ".png",
    cap="params_table_timefe_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
heatmap_params_table_re_consol = heatmap(
    ...
    mask=False,
    colourmap="vlag",
    outputfile="output/params_table_re_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
telsendimg(
    conf=tel_config,
    path="output/params_table_re_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
    + hhbasis_suffix
    + ".png",
    cap="params_table_re_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
for outcome in tqdm(list_outcome_choices):
    ...
    if round == 1:
        params_table_ind_ols_consol = pd.DataFrame(
            params_table_ind_ols.loc[income_choice]
        ).transpose()
    elif round >= 1:
        params_table_ind_ols_consol = pd.concat(
            [
                params_table_ind_ols_consol,
                pd.DataFrame(params_table_ind_ols.loc[income_choice]).transpose(),
            ],
            axis=0,
        )
    round += 1
params_table_ind_ols_consol["outcome_variable"] = params_table_ind_ols_consol[
    "outcome_variable"
].replace(dict_cons_nice)
...
heatmap_params_table_ind_ols_consol = heatmap(
    ...
    mask=False,
    colourmap="vlag",
    outputfile="output/params_table_ind_ols_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
telsendimg(
    conf=tel_config,
    path="output/params_table_ind_ols_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
    + hhbasis_suffix
    + ".png",
    cap="params_table_ind_ols_consol_strat_cons"
    + "_"
    + income_choice
    + "_"
    + fd_suffix
...
params_table_ind_ols_consol = params_table_ind_ols_consol.set_index("outcome_variable")
params_table_ind_ols_consol = params_table_ind_ols_consol[
    ["gross_income_group", "Parameter", "LowerCI", "UpperCI"]
]
if not show_ci:
    for col in ["LowerCI", "UpperCI"]:
        del params_table_ind_ols_consol[col]
...
# X --- Notify
telsendmsg(conf=tel_config, msg="impact-household --- analysis_reg_strat: COMPLETED")
