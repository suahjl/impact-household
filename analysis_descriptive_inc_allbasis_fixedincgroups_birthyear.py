...
list_cat_outcomes = [
    "hh_size_group"
] + list_groups  # only available for total household basis
        ...
        for t in tqdm(list(data["year"].unique())):
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.9)
                    )
                    & (data["year"] == t)
                ),
                "gross_income_group",
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.8)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.9)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.7)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.8)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.6)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.7)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.5)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.6)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.4)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.5)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.3)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.4)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.2)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.3)
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.1)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.2)
        ...
        for t in tqdm(list(data["year"].unique())):
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.99)
                    )
                    & (data["year"] == t)
                ),
                "gross_income_group",
            ...
            data.loc[
                (
                    (
                        data["gross_income"]
                        >= data.loc[data["year"] == t, "gross_income"].quantile(q=0.95)
                    )
                    & (
                        data["gross_income"]
                        < data.loc[data["year"] == t, "gross_income"].quantile(q=0.99)
...
for outcome in tqdm(base_outcomes):
    for t in [2022, 2019, 2016, 2014]:
        ...
        list_heattables_mean_names = list_heattables_mean_names + [
            heattable_mean_name
        ]  # separate file
        list_heattables_min_names = list_heattables_min_names + [
            heattable_min_name
        ]  # separate file
        list_heattables_max_names = list_heattables_max_names + [
            heattable_max_name
        ]  # separate file
        list_heattables_allstats_names = list_heattables_allstats_names + [
            heattable_allstats_name
        ]  # separate file
        round = 1
        ...
        tab_allstats_consol = (
            tab_min_consol.round(0).astype("int").astype("str")
            + "\n"
            + " to "
            + "\n"
